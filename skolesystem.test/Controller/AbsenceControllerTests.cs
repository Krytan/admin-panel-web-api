...
namespace skolesystem.Tests.Controller
{
    ...
    {
        new Absence { absence_id = 1, user_id = 1, teacher_id = 1, class_id = 1, absence_date = "12/12/2023", reason = "Reason 1", is_deleted = false },
        new Absence { absence_id = 2, user_id = 2, teacher_id = 2, class_id = 2, absence_date = "12/12/2023", reason = "Reason 2", is_deleted = false },
    };
        ...
        public async Task GetAbsenceById_ShouldReturnAbsenceReadDto_WhenAbsenceExists()
        {
            // Arrange
            int absenceId = 1;
            var existingAbsence = new Absence { absence_id = absenceId, user_id = 1, teacher_id = 1, class_id = 1, absence_date = "12/12/2023", reason = "Reason 1", is_deleted = false };
        ...
        public async Task UpdateAbsence_ShouldReturnNoContent_WhenUpdateAbsenceExists()
        {
            ...
            int absenceId = 1;
            var existingAbsence = new Absence { absence_id = absenceId, user_id = 1, teacher_id = 1, class_id = 1, absence_date = "12/12/2023", reason = "Reason 1", is_deleted = false };
            var updatedAbsenceDto = new AbsenceUpdateDto { user_id = 2, teacher_id = 2, class_id = 2, absence_date = "12/12/2023", reason = "Updated Reason" };
