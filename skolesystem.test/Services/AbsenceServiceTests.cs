...
namespace skolesystem.Tests.Services
{
        ...
        public async Task GetDeletedAbsences_ShouldReturnListOfDeletedAbsenceReadDto_WhenDeletedAbsencesExist()
        {
            ...
            {
            new Absence { absence_id = 1, user_id = 1, teacher_id = 1, class_id = 1, absence_date = "12/12/2023", reason = "Reason 1", is_deleted = true },
            new Absence { absence_id = 2, user_id = 2, teacher_id = 2, class_id = 2, absence_date = "12/12/2023", reason = "Reason 2", is_deleted = true },
            };
